...
public abstract class SamReaderFactory {
    ...
    /** Set this factory's {@link htsjdk.samtools.fork.SAMRecordFactory} to the provided one, then returns itself. */
     ...
     * {@link htsjdk.samtools.fork.DefaultSAMRecordFactory}.
     */
