...
public interface SamReader extends Iterable<SAMRecord>, Closeable {
    ...
    /**
     * @return the {@link htsjdk.samtools.fork.SamReader.Type} of this {@link htsjdk.samtools.fork.SamReader}
     */
    public Type type();
     ...
     *                  and abutting intervals merged.  This can be done with {@link htsjdk.samtools.fork.QueryInterval#optimizeIntervals}
